...
<div style="padding: 1.5rem 1.5rem; border-radius: 16px; background: linear-gradient(135deg, #0b0b0f 0%, #1a1a2e 100%); color: #ffffff;">
  <h1 style="margin-top: 0;">Risalah Saloqum / The Saloqum Treatise</h1>
  <p style="font-size: 1.05rem; line-height: 1.6;">
    Portal kanonik <strong>The Cohesive Tetrad</strong> (tetralogi). DOI-first, structured-data-first.
    Edisi Indonesia adalah rujukan kanonik, edisi Inggris adalah terjemahan resmi.
  </p>
  <div style="display: flex; gap: 12px; flex-wrap: wrap; margin-top: 1rem;">
    <a href="./volumes/t1-ontology/" style="padding: 10px 16px; background: #4f46e5; color: white; border-radius: 8px; text-decoration: none;">Lihat T1 Ontology</a>
    <a href="./releases/" style="padding: 10px 16px; background: #111827; color: white; border-radius: 8px; text-decoration: none; border: 1px solid #374151;">Buka Releases</a>
  </div>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 16px;">
  <div style="border: 1px solid #e5e7eb; border-radius: 12px; padding: 16px;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 8px; margin-top: 8px;">
      <a href="../releases/t1-ontology/id/Risalah-Saloqum_The-Cohesive-Tetrad-Hakikat-Kebenaran_ID_v1.0.pdf" style="padding: 8px 12px; background: #111827; color: #ffffff; border-radius: 6px; text-decoration: none;">ID PDF</a>
      <a href="../releases/t1-ontology/id/Risalah-Saloqum_The-Cohesive-Tetrad-Hakikat-Kebenaran_ID_v1.0.md" style="padding: 8px 12px; background: #f3f4f6; color: #111827; border-radius: 6px; text-decoration: none;">ID MD</a>
      <a href="../releases/t1-ontology/en/Saloqum-Treatise_The-Cohesive-Tetrad-The-Nature-of-Truth_EN_v1.0.pdf" style="padding: 8px 12px; background: #111827; color: #ffffff; border-radius: 6px; text-decoration: none;">EN PDF</a>
      <a href="../releases/t1-ontology/en/Saloqum-Treatise_The-Cohesive-Tetrad-The-Nature-of-Truth_EN_v1.0.md" style="padding: 8px 12px; background: #f3f4f6; color: #111827; border-radius: 6px; text-decoration: none;">EN MD</a>
    </div>
  </div>
  <div style="border: 1px solid #e5e7eb; border-radius: 12px; padding: 16px;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 8px; margin-top: 8px;">
      <a href="../releases/t4-methodology/id/Risalah-Saloqum_The-Cohesive-Tetrad-Bahasa-Kebenaran_ID_v1.0.pdf" style="padding: 8px 12px; background: #111827; color: #ffffff; border-radius: 6px; text-decoration: none;">ID PDF</a>
      <a href="../releases/t4-methodology/id/Risalah-Saloqum_The-Cohesive-Tetrad-Bahasa-Kebenaran_ID_v1.0.md" style="padding: 8px 12px; background: #f3f4f6; color: #111827; border-radius: 6px; text-decoration: none;">ID MD</a>
      <a href="../releases/t4-methodology/en/Saloqum-Treatise_The-Cohesive-Tetrad-The-Languages-of-Truth_EN_v1.0.pdf" style="padding: 8px 12px; background: #111827; color: #ffffff; border-radius: 6px; text-decoration: none;">EN PDF</a>
      <a href="../releases/t4-methodology/en/Saloqum-Treatise_The-Cohesive-Tetrad-The-Languages-of-Truth_EN_v1.0.md" style="padding: 8px 12px; background: #f3f4f6; color: #111827; border-radius: 6px; text-decoration: none;">EN MD</a>
    </div>
  </div>
</div>
