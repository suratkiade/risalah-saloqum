---
title: "T1 Ontology"
description: "Tetralogi 1 (Ontologi) untuk The Cohesive Tetrad. Identitas rilis, DOI, dan tautan berkas rilis (ID kanonik dan EN terjemahan resmi)."
keywords: "T1 Ontology, Ontologi, Hakikat Kebenaran, Di Bawah Takhta Neraca, The Cohesive Tetrad, Risalah Saloqum, DOI"
---
...
### ID (kanonik)
- Judul: The Cohesive Tetrad: Hakikat Kebenaran
- Subjudul: Di Bawah Takhta Neraca
- DOI: [https://doi.org/10.17605/OSF.IO/G8NEH](https://doi.org/10.17605/OSF.IO/G8NEH)
...
- **[T2 Epistemology](t2-epistemology.md)** → kerangka pengetahuan yang beroperasi di atas dasar ontologis.
- **[T3 Axiology](t3-axiology.md)** → nilai dan orientasi tindakan yang ditopang struktur ontologi.
- **[T4 Methodology](t4-methodology.md)** → metode operasional yang mengeksekusi prinsip ontologi secara prosedural.
